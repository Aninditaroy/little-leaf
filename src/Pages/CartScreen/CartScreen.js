...
const CartScreen = () => {
    ...
    return (
        <div className="">
            ...
            <div>
                <h2 className="mb-10 text-center">Items in your shopping cart</h2>
                <div>
                    ...
                    <div className="flex md:flex-row flex-col justify-center mb-56 " id="cart">
                        <div className="lg:w-1/2 w-full md:pl-10 pl-4 pr-10 md:pr-4 lg:pr-4 xl:pr-4 md:pb-0 lg:pb-0 xl:pb-0 md:pt-12 lg:pt-12 xl:pt-12 pb-0 pt-8 bg-white" id="scroll">
                        ...
                        <div className="xl:w-1/2 md:w-1/3 xl:w-1/4 w-full bg-gray-100  mt-0 md:mt-44 lg:mt-44 xl:mt-44">
