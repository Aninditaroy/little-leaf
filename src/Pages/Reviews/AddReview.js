...
const AddReview = ({ productId }) => {
    ...
    return (
        <div class=" container w-full mx-auto  px-5 md:px-0">
            <div className='bg-white p-10 flex flex-col  mx-auto  max-w-full col-span-1'>
                ...
                <form onSubmit={handleSubmit(onSubmit)} class="mt-10">
                    ...
                    <div class="grid gap-6 sm:grid-cols-2">
                        <div class="relative z-0">
                            ...
                            <label class="absolute top-3 -z-10 origin-[0] -translate-y-6 scale-75 transform text-sm text-gray-500 duration-300 peer-placeholder-shown:translate-y-0 peer-placeholder-shown:scale-100 peer-focus:left-0 peer-focus:-translate-y-6 peer-focus:scale-75 peer-focus:text-green-700 peer-focus:dark:text-green-600 mb-1">Your name</label>
                        </div>
                        <div class="relative z-0">
